...
module.exports = class ElectronicBilling extends AfipWebService {
	 ...
	 * @return int 
	 **/
	async getLastVoucher(salesPoint, type, tokenAuth) {
	 ...
	 **/
	async createVoucher(data, tokenAuth, returnResponse = false) {
		const req = {
			'tokenAuth' : tokenAuth,
			'FeCAEReq' : {
				'FeCabReq' : {
	 ...
	 * 	voucher]
	 **/
	async createNextVoucher(data, tokenAuth) {
	 ...
	 **/
	async getVoucherInfo(number, salesPoint, type, tokenAuth) {
		const req = {
			'tokenAuth' : tokenAuth,
			'FeCompConsReq' : {
				'CbteNro' 	: number,
	 ...
	 **/
	async getSalesPoints(tokenAuth) {
		return (await this.executeRequest('FEParamGetPtosVenta',{
			'tokenAuth' : tokenAuth
		})).ResultGet.PtoVenta;
	}
	 ...
	 **/
	async getVoucherTypes(tokenAuth) {
		return (await this.executeRequest('FEParamGetTiposCbte',{
			'tokenAuth' : tokenAuth
		})).ResultGet.CbteTipo;
	}
	 ...
	 **/
	async getConceptTypes(tokenAuth) {
		return (await this.executeRequest('FEParamGetTiposConcepto',{
			'tokenAuth' : tokenAuth
	 ...
	 **/
	async getDocumentTypes(tokenAuth) {
		return (await this.executeRequest('FEParamGetTiposDoc',{
			'tokenAuth' : tokenAuth
		})).ResultGet.DocTipo;
	}
	 ...
	 **/
	async getAliquotTypes(tokenAuth) {
		return (await this.executeRequest('FEParamGetTiposIva',{
			'tokenAuth' : tokenAuth
		})).ResultGet.IvaTipo;
	}
	 ...
	 **/
	async getCurrenciesTypes(tokenAuth) {
		return (await this.executeRequest('FEParamGetTiposMonedas',{
			'tokenAuth' : tokenAuth
		})).ResultGet.Moneda;
	}
	 ...
	 **/
	async getOptionsTypes(tokenAuth) {
		return (await this.executeRequest('FEParamGetTiposOpcional',{
			'tokenAuth' : tokenAuth
	 ...
	 **/
	async getTaxTypes(tokenAuth) {
		return (await this.executeRequest('FEParamGetTiposTributos',{
			'tokenAuth' : tokenAuth
	 ...
	 * server status}
	 **/
	async getServerStatus(tokenAuth) {
	...
	{
		Object.assign(params, await this.getWSInitialRequest(operation,params.tokenAuth)); 
